        ...
        <div class="m-playbar m-playbar-lock" style="top: -53px; visibility: visible;">
            ...
            <div class="wrap" style="margin-left: -498.5px;">
                ...
                <div class="btns" id ="btns">
                    ...
                    <a href="javascript:;" title="播放/暂停" class="ply j-flag" data-action="play" @click="playMusic()" ref="playAudio">播放</a>
            ...
            <div class="list" id="g-playlist" style="display:none;" data-action='hidden'>
                ...
                <div class="listbd">
                    ...
                    <div class="msk"></div>
                    <div class="listbdc j-flag" id="listbdc">
                        <ul class="f-cb" id="listUL" @mousewheel="mouseSlide()">
                    ...
                    <div class="bline j-flag" id="wrap-scrollerbar">
                        <span id="scrollerbar" class="scrol" style="height:240px; display:block; top : 0px;" @mousedown="scrollerBar()"></span>
                    </div>
...
export default {
    ...
    methods: {
        ...
        async playMusic(){
            ...
            let status = play[0].getAttribute('data-action');
            if(status == 'play'){
                audio.play();
                ...
                audio.pause();
                play[0].setAttribute('data-action','play');
                play[0].classList.remove('pas');
            }
        },
        //时间转换
        transTime(value) {
        ...
        async changeMusic(){
            ...
            console.log(this.songIds[this.songindex]);
